...
import net.vleo.timel.impl.downscaler.IntegralFloatDownscaler;
import net.vleo.timel.impl.upscaler.IntegralFloatUpscaler;
...
public class IntegralFloatType extends IntegralType<Float> {
    ...
    public Upscaler<?> getUpscaler() {
        ...
        return new IntegralFloatUpscaler();
    }

    @Override
    public Downscaler<?> getDownscaler() {
        return new IntegralFloatDownscaler();
    }
