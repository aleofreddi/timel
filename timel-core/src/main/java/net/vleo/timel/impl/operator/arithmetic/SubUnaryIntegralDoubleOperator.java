...
/**
 * Integral double unary sub implementation.
 *
...
public class SubUnaryIntegralDoubleOperator extends SubUnaryDoubleOperator implements SameTypeArgumentsFunction<Double> {
}
