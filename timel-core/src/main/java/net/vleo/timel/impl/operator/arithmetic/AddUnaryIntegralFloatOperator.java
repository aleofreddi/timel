...
/**
 * Integral float unary add implementation.
 *
...
public class AddUnaryIntegralFloatOperator extends AddUnaryFloatOperator implements SameTypeArgumentsFunction<Float> {
}
