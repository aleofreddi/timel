...
public class CompilationUnit extends AbstractSyntaxTree {
    public CompilationUnit(AbstractParseTree reference, List<AbstractSyntaxTree> children) {
        super(reference, children.get(children.size() - 1).getType(), children);
    }
