...
/**
 * Integral integer div implementation (rhs integral).
 *
...
@Prototype(
        ...
        constraints = {
                @Constraint(variable = "T", template = IntegralIntegerType.class)
        }
)
public class DivIntegralIntegerInverseOperator extends MulIntegerOperator {
    @Override
    public Optional<Type> resolveReturnType(Type proposed, Map<String, Type> variables, Type... argumentTypes) {
        ...
        return Optional.of(new IntegralIntegerType(-t));
    }
}
