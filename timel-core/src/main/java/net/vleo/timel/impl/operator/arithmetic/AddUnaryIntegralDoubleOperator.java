...
/**
 * Integral double unary add implementation.
 *
 * @author Andrea Leofreddi
 */
@FunctionPrototype(
        name = "+",
        returns = @Returns(type = IntegralDoubleType.class),
        parameters = {
                @Parameter(type = IntegralDoubleType.class)
        }
)
public class AddUnaryIntegralDoubleOperator extends AddUnaryDoubleOperator implements SameTypeArgumentsFunction<Double> {
}
