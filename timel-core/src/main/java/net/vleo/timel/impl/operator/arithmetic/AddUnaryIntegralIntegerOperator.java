...
/**
 * Integral integer unary add implementation.
 *
...
public class AddUnaryIntegralIntegerOperator extends AddUnaryIntegerOperator implements SameTypeArgumentsFunction<Integer> {
}
