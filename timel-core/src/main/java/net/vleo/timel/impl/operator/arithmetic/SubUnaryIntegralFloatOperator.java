...
/**
 * Integral float unary sub implementation.
 *
...
public class SubUnaryIntegralFloatOperator extends SubUnaryFloatOperator implements SameTypeArgumentsFunction<Float> {
}
