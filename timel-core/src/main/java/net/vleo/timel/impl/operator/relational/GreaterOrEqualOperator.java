...
/**
 * Greater or equal operator implementation.
 *
...
public class GreaterOrEqualOperator extends AbstractBinaryPredicate<Comparable<Object>> {
    @Override
    protected boolean apply(Comparable<Object> t, Comparable<Object> u) {
