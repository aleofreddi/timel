...
/**
 * Represent a weighted edge between to nodes. There is a {@link DirectPath} for each edge provided when initializing the {@link WeightedPoset}.
 *
 ...
 */
@Value
class DirectPath<N, E extends Edge<N>> implements Path<N, E> {
