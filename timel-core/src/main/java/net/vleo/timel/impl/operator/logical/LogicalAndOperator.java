...
/**
 * Implementation of the logical and operator that applies the following truth table:
 *
 * +------+------+--------+
 * |  A   |  B   | A && B |
 * +------+------+--------+
...
public class LogicalAndOperator extends AbstractTrivalentLogicalOperator {
    @Override
