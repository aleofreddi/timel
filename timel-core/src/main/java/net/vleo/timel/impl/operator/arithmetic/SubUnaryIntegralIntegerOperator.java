...
/**
 * Integral integer unary sub implementation.
 *
...
public class SubUnaryIntegralIntegerOperator extends SubUnaryIntegerOperator implements SameTypeArgumentsFunction<Integer> {
}
