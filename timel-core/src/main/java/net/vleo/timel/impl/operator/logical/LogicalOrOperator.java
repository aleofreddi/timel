...
/**
 * Implementation of the logical or operator that applies the following truth table:
 *
 * +------+------+--------+
 * |  A   |  B   | A || B |
 * +------+------+--------+
...
public class LogicalOrOperator extends AbstractTrivalentLogicalOperator {
    @Override
