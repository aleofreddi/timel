 ...
 */
@ConversionPrototype(source = IntegralFloatType.class, target = IntegralIntegerType.class)
public class IntegralFloatToIntegralIntegerConversion extends FloatToIntegerConversion {
}
