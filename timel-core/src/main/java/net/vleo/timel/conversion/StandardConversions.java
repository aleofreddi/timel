...
public final class StandardConversions {
    public static final Set<Conversion<?, ?>> STANDARD_CONVERSIONS = new HashSet<>(asList(
            // *** Implicit
            ...
            new IntegralDoubleToIntegralFloatConversion(),
            new IntegralDoubleToIntegralIntegerConversion(),
            new IntegralFloatToIntegralIntegerConversion()
    ));
