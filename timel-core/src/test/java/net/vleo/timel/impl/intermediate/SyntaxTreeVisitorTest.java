 ...
 */
class SyntaxTreeVisitorTest {
    @Test
    void shouldReturnNullForEachVisitMethod() {
        val visitor = new SyntaxTreeVisitor<Object>() {
        };

        assertThat(
                Arrays.stream(SyntaxTreeVisitor.class.getDeclaredMethods())
    ...
    private static Object invokeVisit(Method method, SyntaxTreeVisitor<Object> visitor) {
        try {
