 ...
 */
public class AbsImpl extends AbstractValueFunction<Double> {
    public static final String TOKEN = "Abs";

    private ValueNode<Double> valueNode;

    public AbsImpl(ValueNode<Double> valueNode) {
