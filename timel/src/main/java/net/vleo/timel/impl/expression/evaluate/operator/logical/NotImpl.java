 ...
 */
public class NotImpl extends AbstractValueFunction<Double> {
    public static final String TOKEN = "Not";

    private final ValueNode<Double> tNode;

    public NotImpl(ValueNode<Double> t) {
        super(NotImpl.TOKEN, Types.getNumericDoubleType(), t);
