 ...
 */
public class EvalStartImpl extends AbstractValueFunction<Long> implements ValueNode<Long> {
    public static final String TOKEN = "EvalStart";

    public EvalStartImpl() {
    ...
    public UpscalableIterator<Long> evaluate(Interval interval, ExecutorContext context) {
        long t = context.getInterval().getStart();
