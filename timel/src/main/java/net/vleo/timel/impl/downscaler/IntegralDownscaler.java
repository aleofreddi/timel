...
/**
 * A downscaler that will compute the sum all the values.
 *
 * @author Andrea Leofreddi
 */
public class IntegralDownscaler extends BufferedTimeIterator<Double> implements TimeIterator<Double> {
    private final UpscalableIterator<Double> iterator;

    private final Interval interval;

    public IntegralDownscaler(UpscalableIterator<Double> iterator, Interval interval) {
        super();
