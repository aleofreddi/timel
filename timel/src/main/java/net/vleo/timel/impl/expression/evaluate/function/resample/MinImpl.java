...
import net.vleo.timel.impl.downscaler.MinDownscaler;
import net.vleo.timel.iterator.TimeIterator;
import net.vleo.timel.time.Interval;

/**
 * Extract the minimum of a value over time.
 *
 * @author Andrea Leofreddi
 */
public class MinImpl<V extends Comparable<V>> extends SimpleDownscalerImpl<V> {
    public static final String TOKEN = "Min";

    private final ValueNode<V> valueNode;

    public MinImpl(ValueNode<V> valueNode, ValueNode<Interval> periodicityNode) throws ParseException {
        super(TOKEN, valueNode.getType(), valueNode, periodicityNode);

        this.valueNode = valueNode;
    }

    public MinImpl(ValueNode<V> valueNode) throws ParseException {
