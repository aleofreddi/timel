...
/**
 * Numeric plus operator implementation.
 *
 * @author Andrea Leofreddi
 */
public class NumericPlusImpl extends AbstractValueFunction<Double> {
    private ValueNode<Double> tNode, uNode;

    private static final String FORMAT = "(%s %s %s)";

    public NumericPlusImpl(ValueType<Double> returnType, ValueNode<Double> tNode, ValueNode<Double> uNode) {
    ...
    /**
     * Assemble the (infixed) representation of the expression node for plus operator.
     */
    @Override
